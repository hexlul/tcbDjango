...
export const crudOptions = vm => {
  return {
    ...
    rowHandle: { // 行操作栏，与d2-crud一致，默认配置有修改与删除
      width: 140,
      view: {
        thin: true,
        text: '',
    ...
    viewOptions: { // 查看组件选项
      disabled: false, // 开启关闭查看view
      componentType: 'form' // 查看时使用哪种组件展示【form=使用表单组件,row=使用行展示组件】
    },
    formOptions: { // 表单组件选项，对应 el-dialog（el-drawer）、el-form  的配置
      type: 'dialog', //  默认对话框模式，drawer 抽屉模式
      defaultSpan: 24, // 默认的表单 span
      width: '35%'
    },
    columns: [{ // 字段配置 ，对应el-table-column的配置
      title: 'ID',
      key: 'id',
      show: false,
      disabled: true,
